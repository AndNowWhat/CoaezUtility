...
public class WinterGarden extends BaseGarden {
    ...
    private static final GuardianRequirement[] GUARDIAN_REQUIREMENTS_WAYPOINT_2 = {
        new GuardianRequirement(5556, new int[][] {
            {2900, 5482, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2900, 5481, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2900, 5480, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2899, 5480, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2898, 5481, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2897, 5481, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2896, 5481, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2896, 5482, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2896, 5483, 0, NPCDirection.Direction.SOUTH.ordinal()},
            {2897, 5483, 0, NPCDirection.Direction.SOUTH.ordinal()}
        }),
        // Keep the 5555 avoid positions requirement as before
    ...
    private static final GuardianRequirement[] GUARDIAN_REQUIREMENTS_WAYPOINT_5 = {
        new GuardianRequirement(5558, 5.0)
    };
    ...
    protected List<Waypoint> getWaypoints() {
        return Arrays.asList(
            ...
            new Waypoint(WAYPOINT_5, "Winter Garden - Fifth Checkpoint", 0)
        );
    }
